            ...
            <section className="max-w-7xl mx-auto px-6 py-20 min-h-[60vh]">
                <AnimatePresence mode="wait">
                    {activeTab === 'resources' && (
                        ...
                        >
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="bg-[#111] border border-white/5 p-8 rounded-2xl group hover:border-white/20 transition-colors">
                                    ...
                                    <h3 className="text-xl font-bold mb-2">{t.support_page.resources.manuals} v{i}.0</h3>
                                    <p className="text-white/40 text-sm mb-6">PDF Document • 2.4 MB</p>
                                    <button className="flex items-center gap-2 text-sm font-bold text-white/80 group-hover:text-blue-400 transition-colors">
                            ...
                            <div className="bg-[#111] border border-white/5 p-8 rounded-2xl group hover:border-white/20 transition-colors">
                                ...
                                <h3 className="text-xl font-bold mb-2">{t.support_page.resources.certifications}</h3>
                                <p className="text-white/40 text-sm mb-6">ISO 13485, CE, FDA Docs</p>
                                <button className="flex items-center gap-2 text-sm font-bold text-white/80 group-hover:text-purple-400 transition-colors">
                                    {t.support_page.resources.download}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" x2="12" y1="15" y2="3"></line></svg>
                                </button>
                            </div>
